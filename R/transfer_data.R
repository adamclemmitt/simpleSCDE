...
#'
#'@examples
#'lat_muscle <- import_csv(file_path = "C:/Users/adamc/Desktop/planaria.xlsx",
#'                         colnames = TRUE)
#'
#'@export
...
#'             file_path = "C:/Users/adamc/Desktop/planaria.xlsx",
...
export_excel <- function(data, file_path, colnames = TRUE, rownames = TRUE,
  ...
  if (!add_to_file) {
    ...
    confirm <- readline("")
    if (confirm == "y") {
      write.xlsx(x = data, file = file_path, col.names = colnames,
      ...
      message("Response must be y or n. Please call function again and
